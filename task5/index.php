...
function connect_to_db()
{
    try {
        include ("./db_data.php");
        $db = new PDO('mysql:host=localhost;dbname=u67426', $user, $pass, [PDO::ATTR_PERSISTENT => true, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION]);
        return $db;
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (
        ...
        if (!empty($submission)) {
            ...
            $values["field-pl"] = sprintf("@%s@", implode("@", $fpls));
        }
    }
